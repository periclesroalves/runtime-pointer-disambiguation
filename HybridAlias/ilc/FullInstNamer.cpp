...
static RegisterPass<FullInstNamer> X(
	// pericles's LLVM version also contains a full-instnamer pass.
	// -> quick n' dirty hack: rename this pass.
	"full-instnamer-duplicate-remove-me",
...
llvm::Value* FullInstNamer::lookup(llvm::Function *fn, StringRef name)
{
	...
	value = fn->getParent()->getNamedGlobal(name);
