...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  %13 = getelementptr inbounds float* %C, i64 %12
  store float %11, float* %13, align 4, !tbaa !3
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %0
  ...
  br i1 %exitcond, label %_Z3fooPiS_Pfi.exit, label %.lr.ph.i

_Z3fooPiS_Pfi.exit:                               ; preds = %.lr.ph.i
