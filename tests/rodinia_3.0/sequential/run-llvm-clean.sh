...
export CC="/home/pericles/ufmg-research/build-release/bin/clang -Xclang -load -Xclang /home/pericles/ufmg-research/build-release/lib/LLVMPolly.so -O3 -mllvm -polly -mllvm -polly-code-generator=none -mllvm -polly-optimizer=none"
export CXX="/home/pericles/ufmg-research/build-release/bin/clang++ -Xclang -load -Xclang /home/pericles/ufmg-research/build-release/lib/LLVMPolly.so -O3 -mllvm -polly -mllvm -polly-code-generator=none -mllvm -polly-optimizer=none"
