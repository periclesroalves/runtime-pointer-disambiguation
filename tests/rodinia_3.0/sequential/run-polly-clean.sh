...
export CC="/home/pericles/ufmg-research/build-release/bin/clang -Xclang -load -Xclang /home/pericles/ufmg-research/build-release/lib/LLVMPolly.so -O3 -mllvm -polly"
export CXX="/home/pericles/ufmg-research/build-release/bin/clang++ -Xclang -load -Xclang /home/pericles/ufmg-research/build-release/lib/LLVMPolly.so -O3 -mllvm -polly"
