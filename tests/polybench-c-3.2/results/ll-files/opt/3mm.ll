...
bb77.clone.i:                                     ; preds = %bb92.clone.i, %.preheader4.clone.i
  ...
  store double 0.000000e+00, double* %tmp79.clone.i, align 8, !tbaa !2, !alias.scope !29, !noalias !32, !llvm.loop !10
  br label %bb81.clone.i

bb81.clone.i:                                     ; preds = %bb81.clone.i, %bb77.clone.i
  %tmp88.clone6.i = phi double [ 0.000000e+00, %bb77.clone.i ], [ %tmp89.clone.i.1, %bb81.clone.i ]
  ...
  %tmp85.clone.i = load double* %tmp83.clone.i, align 8, !tbaa !2, !alias.scope !35, !noalias !36
  %tmp86.clone.i = load double* %tmp84.clone.i, align 8, !tbaa !2, !alias.scope !37, !noalias !38
  %tmp87.clone.i = fmul double %tmp85.clone.i, %tmp86.clone.i
  %tmp89.clone.i = fadd double %tmp88.clone6.i, %tmp87.clone.i
  ...
  %tmp85.clone.i.1 = load double* %tmp83.clone.i.1, align 8, !tbaa !2, !alias.scope !35, !noalias !36
  %tmp86.clone.i.1 = load double* %tmp84.clone.i.1, align 8, !tbaa !2, !alias.scope !37, !noalias !38
  ...
  br i1 %tmp91.clone.i.1, label %bb92.clone.i, label %bb81.clone.i, !llvm.loop !39

bb92.clone.i:                                     ; preds = %bb81.clone.i
  %tmp89.clone.i.lcssa = phi double [ %tmp89.clone.i.1, %bb81.clone.i ]
  store double %tmp89.clone.i.lcssa, double* %tmp79.clone.i, align 8, !tbaa !2, !alias.scope !29, !noalias !32
  %tmp93.clone.i = add i64 %tmp78.clone.i, 1
  %tmp94.clone.i = icmp eq i64 %tmp93.clone.i, 1024
  br i1 %tmp94.clone.i, label %bb95.clone.i, label %bb77.clone.i, !llvm.loop !40

bb95.clone.i:                                     ; preds = %bb92.clone.i
  %tmp96.clone.i = add i64 %tmp71.clone.i, 1
  %tmp97.clone.i = icmp eq i64 %tmp96.clone.i, 1024
  br i1 %tmp97.clone.i, label %.preheader3.i.loopexit, label %.preheader4.clone.i, !llvm.loop !41
...
bb104.clone.i:                                    ; preds = %bb119.clone.i, %.preheader2.clone.i
  ...
  store double 0.000000e+00, double* %tmp106.clone.i, align 8, !tbaa !2, !alias.scope !42, !noalias !44, !llvm.loop !47
  br label %bb108.clone.i

bb108.clone.i:                                    ; preds = %bb108.clone.i, %bb104.clone.i
  %tmp115.clone5.i = phi double [ 0.000000e+00, %bb104.clone.i ], [ %tmp116.clone.i.1, %bb108.clone.i ]
  ...
  %tmp112.clone.i = load double* %tmp110.clone.i, align 8, !tbaa !2, !alias.scope !48, !noalias !49
  %tmp113.clone.i = load double* %tmp111.clone.i, align 8, !tbaa !2, !alias.scope !50, !noalias !51
  %tmp114.clone.i = fmul double %tmp112.clone.i, %tmp113.clone.i
  %tmp116.clone.i = fadd double %tmp115.clone5.i, %tmp114.clone.i
  ...
  %tmp112.clone.i.1 = load double* %tmp110.clone.i.1, align 8, !tbaa !2, !alias.scope !48, !noalias !49
  %tmp113.clone.i.1 = load double* %tmp111.clone.i.1, align 8, !tbaa !2, !alias.scope !50, !noalias !51
...
bb119.clone.i:                                    ; preds = %bb108.clone.i
  %tmp116.clone.i.lcssa = phi double [ %tmp116.clone.i.1, %bb108.clone.i ]
  store double %tmp116.clone.i.lcssa, double* %tmp106.clone.i, align 8, !tbaa !2, !alias.scope !42, !noalias !44
  %tmp120.clone.i = add i64 %tmp105.clone.i, 1
  %tmp121.clone.i = icmp eq i64 %tmp120.clone.i, 1024
  br i1 %tmp121.clone.i, label %bb122.clone.i, label %bb104.clone.i, !llvm.loop !52

bb122.clone.i:                                    ; preds = %bb119.clone.i
  %tmp123.clone.i = add i64 %tmp98.clone.i, 1
  %tmp124.clone.i = icmp eq i64 %tmp123.clone.i, 1024
  br i1 %tmp124.clone.i, label %.preheader1.i.loopexit, label %.preheader2.clone.i, !llvm.loop !53
...
bb81.i:                                           ; preds = %bb81.i, %bb77.i
  ...
  br i1 %tmp91.i36.1, label %bb92.i, label %bb81.i, !llvm.loop !39

bb92.i:                                           ; preds = %bb81.i
  %tmp93.i37 = add i64 %tmp78.i, 1
  %tmp94.i = icmp eq i64 %tmp93.i37, 1024
  br i1 %tmp94.i, label %bb95.i, label %bb77.i, !llvm.loop !40

bb95.i:                                           ; preds = %bb92.i
  %tmp96.i = add i64 %tmp71.i27, 1
  %tmp97.i = icmp eq i64 %tmp96.i, 1024
  br i1 %tmp97.i, label %.preheader3.i.loopexit117, label %.preheader4.i28, !llvm.loop !41
...
bb127.clone.i:                                    ; preds = %bb142.clone.i, %.preheader.clone.i
  ...
  store double 0.000000e+00, double* %tmp129.clone.i, align 8, !tbaa !2, !alias.scope !54, !noalias !56, !llvm.loop !59
  br label %bb131.clone.i

bb131.clone.i:                                    ; preds = %bb131.clone.i, %bb127.clone.i
  %tmp138.clone4.i = phi double [ 0.000000e+00, %bb127.clone.i ], [ %tmp139.clone.i.1, %bb131.clone.i ]
  ...
  %tmp135.clone.i = load double* %tmp133.clone.i, align 8, !tbaa !2, !alias.scope !60, !noalias !61
  %tmp136.clone.i = load double* %tmp134.clone.i, align 8, !tbaa !2, !alias.scope !62, !noalias !63
  %tmp137.clone.i = fmul double %tmp135.clone.i, %tmp136.clone.i
  %tmp139.clone.i = fadd double %tmp138.clone4.i, %tmp137.clone.i
  ...
  %tmp135.clone.i.1 = load double* %tmp133.clone.i.1, align 8, !tbaa !2, !alias.scope !60, !noalias !61
  %tmp136.clone.i.1 = load double* %tmp134.clone.i.1, align 8, !tbaa !2, !alias.scope !62, !noalias !63
  ...
  br i1 %tmp141.clone.i.1, label %bb142.clone.i, label %bb131.clone.i, !llvm.loop !64

bb142.clone.i:                                    ; preds = %bb131.clone.i
  %tmp139.clone.i.lcssa = phi double [ %tmp139.clone.i.1, %bb131.clone.i ]
  store double %tmp139.clone.i.lcssa, double* %tmp129.clone.i, align 8, !tbaa !2, !alias.scope !54, !noalias !56
  %tmp143.clone.i = add i64 %tmp128.clone.i, 1
  %tmp144.clone.i = icmp eq i64 %tmp143.clone.i, 1024
  br i1 %tmp144.clone.i, label %bb145.clone.i, label %bb127.clone.i, !llvm.loop !65

bb145.clone.i:                                    ; preds = %bb142.clone.i
  %tmp146.clone.i = add i64 %tmp125.clone.i, 1
  %tmp147.clone.i = icmp eq i64 %tmp146.clone.i, 1024
  br i1 %tmp147.clone.i, label %kernel_3mm.exit.loopexit, label %.preheader.clone.i, !llvm.loop !66
...
bb104.i:                                          ; preds = %bb119.i, %.preheader2.i38
  ...
  store double 0.000000e+00, double* %tmp106.i40, align 8, !tbaa !2, !llvm.loop !47
  br label %bb108.i
...
bb108.i:                                          ; preds = %bb108.i, %bb104.i
  ...
  store double %tmp116.i, double* %tmp106.i40, align 8, !tbaa !2, !llvm.loop !67
  ...
  store double %tmp116.i.1, double* %tmp106.i40, align 8, !tbaa !2, !llvm.loop !67
...
bb119.i:                                          ; preds = %bb108.i
  ...
  br i1 %tmp121.i48, label %bb122.i, label %bb104.i, !llvm.loop !52

bb122.i:                                          ; preds = %bb119.i
  %tmp123.i49 = add i64 %tmp98.i, 1
  %tmp124.i50 = icmp eq i64 %tmp123.i49, 1024
  br i1 %tmp124.i50, label %.preheader1.i.loopexit116, label %.preheader2.i38, !llvm.loop !53
...
bb127.i:                                          ; preds = %bb142.i, %.preheader.i51
  ...
  store double 0.000000e+00, double* %tmp129.i, align 8, !tbaa !2, !llvm.loop !59
  br label %bb131.i
...
bb131.i:                                          ; preds = %bb131.i, %bb127.i
  ...
  store double %tmp139.i, double* %tmp129.i, align 8, !tbaa !2, !llvm.loop !68
  ...
  store double %tmp139.i.1, double* %tmp129.i, align 8, !tbaa !2, !llvm.loop !68
  %tmp140.i.1 = add i64 %tmp140.i, 1
  %tmp141.i.1 = icmp eq i64 %tmp140.i.1, 1024
  br i1 %tmp141.i.1, label %bb142.i, label %bb131.i, !llvm.loop !64

bb142.i:                                          ; preds = %bb131.i
  %tmp143.i = add i64 %tmp128.i52, 1
  %tmp144.i = icmp eq i64 %tmp143.i, 1024
  br i1 %tmp144.i, label %bb145.i, label %bb127.i, !llvm.loop !65

bb145.i:                                          ; preds = %bb142.i
  %tmp146.i = add i64 %tmp125.i, 1
  %tmp147.i = icmp eq i64 %tmp146.i, 1024
  br i1 %tmp147.i, label %kernel_3mm.exit.loopexit115, label %.preheader.i51, !llvm.loop !66
...
bb25:                                             ; preds = %print_array.exit, %bb19, %kernel_3mm.exit
  ...
  tail call void @free(i8* %tmp3), !llvm.loop !69
  tail call void @free(i8* %tmp4), !llvm.loop !19
  tail call void @free(i8* %tmp5), !llvm.loop !39
  tail call void @free(i8* %tmp6), !llvm.loop !70
  ret i32 0, !llvm.loop !40
}
...
!30 = metadata !{metadata !30, metadata !31, metadata !"kernel_3mm: %E"}
!31 = metadata !{metadata !31, metadata !"kernel_3mm"}
!32 = metadata !{metadata !33, metadata !34}
!33 = metadata !{metadata !33, metadata !31, metadata !"kernel_3mm: %A"}
!34 = metadata !{metadata !34, metadata !31, metadata !"kernel_3mm: %B"}
!35 = metadata !{metadata !33}
!36 = metadata !{metadata !30, metadata !34}
!37 = metadata !{metadata !34}
!38 = metadata !{metadata !30, metadata !33}
!39 = metadata !{metadata !"void13"}
!40 = metadata !{metadata !"void15"}
!41 = metadata !{metadata !"void17"}
!42 = metadata !{metadata !43}
!43 = metadata !{metadata !43, metadata !31, metadata !"kernel_3mm: %F"}
!44 = metadata !{metadata !45, metadata !46}
!45 = metadata !{metadata !45, metadata !31, metadata !"kernel_3mm: %C"}
!46 = metadata !{metadata !46, metadata !31, metadata !"kernel_3mm: %D"}
!47 = metadata !{metadata !"void23"}
!48 = metadata !{metadata !45}
!49 = metadata !{metadata !43, metadata !46}
!50 = metadata !{metadata !46}
!51 = metadata !{metadata !43, metadata !45}
!52 = metadata !{metadata !"void29"}
!53 = metadata !{metadata !"void31"}
!54 = metadata !{metadata !55}
!55 = metadata !{metadata !55, metadata !31, metadata !"kernel_3mm: %G"}
!56 = metadata !{metadata !57, metadata !58}
!57 = metadata !{metadata !57, metadata !31, metadata !"kernel_3mm: %E"}
!58 = metadata !{metadata !58, metadata !31, metadata !"kernel_3mm: %F"}
!59 = metadata !{metadata !"void34"}
!60 = metadata !{metadata !57}
!61 = metadata !{metadata !58, metadata !55}
!62 = metadata !{metadata !58}
!63 = metadata !{metadata !57, metadata !55}
!64 = metadata !{metadata !"void38"}
!65 = metadata !{metadata !"void40"}
!66 = metadata !{metadata !"void42"}
!67 = metadata !{metadata !"void26"}
!68 = metadata !{metadata !"void37"}
!69 = metadata !{metadata !"void11"}
!70 = metadata !{metadata !"void14"}
