...
void f1(long int nmb,long int firstdiv, Factorization *nmbfct,Factorization
    **fctlist, Factorization *divfct){
...
void ExtendFactors(long int nmb,long int firstdiv,
  ...
  f1(nmb, firstdiv, nmbfct, fctlist, divfct);
}

void f2(long int prnum,long int *prlist,
                            Factorization **fctlist, Factorization *fct){
