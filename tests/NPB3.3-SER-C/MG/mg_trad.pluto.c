...
/* Start of CLooG code */
  for (i3 = 1; i3 < n3-1; i3++) {
    for (i2 = 1; i2 < n2-1; i2++) {
      for (i1 = 2; i1 < n1; i1++) {
        u[i3][i2][i1-1] = u[i3][i2][i1-1]
                      + c[0] * r[i3][i2][i1-1]
                      + c[1] * ( r[i3][i2][i1-2] + r[i3][i2][i1]
                               + r[i3][i2-1][i1-1]+r[i3][i2+1][i1-1]+r[i3-1][i2][i1-1]+r[i3+1][i2][i1-1] )
                      + c[2] * ( r[i3-1][i2-1][i1-1]+r[i3-1][i2+1][i1-1]+r[i3+1][i2-1][i1-1] +r[i3+1][i2+1][i1-1] + r[i3][i2-1][i1-2]+r[i3][i2+1][i1-2]+r[i3-1][i2][i1-2]+r[i3+1][i2][i1-2] + r[i3][i2-1][i1] + r[i3][i2+1][i1]+ r[i3-1][i2][i1] + r[i3+1][i2][i1] );
        //--------------------------------------------------------------------
...
#pragma omp parallel for private(lbv,ubv)
  for (t1=lbp;t1<=ubp;t1++) {
    for (t2=0;t2<=floord(n2-2,84);t2++) {
      for (t3=0;t3<=floord(n1-1,84);t3++) {
        for (t5=max(1,84*t2);t5<=min(n2-2,84*t2+83);t5++) {
          lbv=max(2,84*t3);
          ubv=min(n1-1,84*t3+83);
#pragma ivdep
#pragma vector always
          for (t6=lbv;t6<=ubv;t6++) {
            u[t1][t5][t6-1]=u[t1][t5][t6-1]+c[0]*r[t1][t5][t6-1]+c[1]*(r[t1][t5][t6-2]+r[t1][t5][t6]+r[t1][t5-1][t6-1]+r[t1][t5+1][t6-1]+r[t1-1][t5][t6-1]+r[t1+1][t5][t6-1])+c[2]*(r[t1-1][t5-1][t6-1]+r[t1-1][t5+1][t6-1]+r[t1+1][t5-1][t6-1]+r[t1+1][t5+1][t6-1]+r[t1][t5-1][t6-2]+r[t1][t5+1][t6-2]+r[t1-1][t5][t6-2]+r[t1+1][t5][t6-2]+r[t1][t5-1][t6]+r[t1][t5+1][t6]+r[t1-1][t5][t6]+r[t1+1][t5][t6]);;
          }
        }
      }
    }
    ...
    for (i2 = 1; i2 < n2-1; i2++) {
      for (i1 = 2; i1 < n1; i1++) {
        r[i3][i2][i1-1] = v[i3][i2][i1-1]
                      - a[0] * u[i3][i2][i1-1]
                      - a[2] * (  u[i3-1][i2-1][i1-1] + u[i3-1][i2+1][i1-1]+ u[i3+1][i2-1][i1-1] + u[i3+1][i2+1][i1-1] + u[i3][i2-1][i1-2] + u[i3][i2+1][i1-2] + u[i3-1][i2][i1-2] + u[i3+1][i2][i1-2] + u[i3][i2-1][i1] + u[i3][i2+1][i1] + u[i3-1][i2][i1] + u[i3+1][i2][i1] )
                      - a[3] * ( u[i3-1][i2-1][i1-2] + u[i3-1][i2+1][i1-2]+ u[i3+1][i2-1][i1-2] + u[i3+1][i2+1][i1-2] + u[i3-1][i2-1][i1] + u[i3-1][i2+1][i1]+ u[i3+1][i2-1][i1] + u[i3+1][i2+1][i1] );
      }
    }
  }
} else {
...
#pragma omp parallel for private(lbv,ubv)
  for (t1=lbp;t1<=ubp;t1++) {
    for (t2=0;t2<=floord(n2-2,72);t2++) {
      for (t3=0;t3<=floord(n1-1,72);t3++) {
        for (t5=max(1,72*t2);t5<=min(n2-2,72*t2+71);t5++) {
          lbv=max(2,72*t3);
          ubv=min(n1-1,72*t3+71);
#pragma ivdep
#pragma vector always
          for (t6=lbv;t6<=ubv;t6++) {
            r[t1][t5][t6-1]=v[t1][t5][t6-1]-a[0]*u[t1][t5][t6-1]-a[2]*(u[t1-1][t5-1][t6-1]+u[t1-1][t5+1][t6-1]+u[t1+1][t5-1][t6-1]+u[t1+1][t5+1][t6-1]+u[t1][t5-1][t6-2]+u[t1][t5+1][t6-2]+u[t1-1][t5][t6-2]+u[t1+1][t5][t6-2]+u[t1][t5-1][t6]+u[t1][t5+1][t6]+u[t1-1][t5][t6]+u[t1+1][t5][t6])-a[3]*(u[t1-1][t5-1][t6-2]+u[t1-1][t5+1][t6-2]+u[t1+1][t5-1][t6-2]+u[t1+1][t5+1][t6-2]+u[t1-1][t5-1][t6]+u[t1-1][t5+1][t6]+u[t1+1][t5-1][t6]+u[t1+1][t5+1][t6]);;
          }
        }
      }
    }
