...
; Function Attrs: nounwind uwtable
define internal void @init_array(i32 %n, [2800 x i32]* noalias %path) #0 {
.split:
  %0 = icmp sgt i32 %n, 0
  br i1 %0, label %.preheader.lr.ph, label %._crit_edge4
...
.lr.ph:                                           ; preds = %.preheader, %16
  ...
  %7 = srem i32 %6, 7
  %8 = add nsw i32 %7, 1
  store i32 %8, i32* %scevgep, align 4, !tbaa !6
  %9 = srem i32 %4, 13
  %10 = icmp eq i32 %9, 0
  %11 = srem i32 %4, 7
  %12 = icmp eq i32 %11, 0
...
; <label>:15                                      ; preds = %.lr.ph
  store i32 999, i32* %scevgep, align 4, !tbaa !6
  br label %16
...
._crit_edge:                                      ; preds = %16, %.preheader
  ...
  br i1 %exitcond7, label %.preheader, label %._crit_edge4

._crit_edge4:                                     ; preds = %._crit_edge, %.split
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @kernel_floyd_warshall(i32 %n, [2800 x i32]* noalias %path) #0 {
.split:
  %0 = icmp sgt i32 %n, 0
...
.lr.ph:                                           ; preds = %.preheader, %9
  ...
  %2 = load i32* %scevgep, align 4, !tbaa !6
  %3 = load i32* %scevgep14, align 4, !tbaa !6
  %4 = load i32* %scevgep11, align 4, !tbaa !6
  %5 = add nsw i32 %4, %3
  %6 = icmp slt i32 %2, %5
...
; <label>:9                                       ; preds = %8, %7
  ...
  store i32 %.reg2mem.0, i32* %scevgep, align 4, !tbaa !6
  %indvar.next = add i64 %indvar, 1
  %exitcond = icmp ne i64 %indvar.next, %1
  br i1 %exitcond, label %.lr.ph, label %._crit_edge
...
._crit_edge4:                                     ; preds = %._crit_edge, %.preheader1
  ...
  br i1 %exitcond15, label %.preheader1, label %._crit_edge6

._crit_edge6:                                     ; preds = %._crit_edge4, %.split
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @print_array(i32 %n, [2800 x i32]* noalias %path) #0 {
  br label %.split
