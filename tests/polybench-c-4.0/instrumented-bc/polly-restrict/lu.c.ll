...
; Function Attrs: nounwind uwtable
define internal void @kernel_lu(i32 %n, [2000 x double]* noalias %A) #0 {
.split:
  %0 = icmp sgt i32 %n, 0
...
polly.loop_header46:                              ; preds = %polly.loop_header, %polly.loop_header46
  ...
  %p_.moved.to.40 = add i64 %4, %polly.indvar
  %p_.moved.to.41 = add i64 %12, %polly.indvar
  %p_scevgep32.moved.to. = getelementptr [2000 x double]* %A, i64 0, i64 %p_.moved.to.41
  %p_scevgep29 = getelementptr [2000 x double]* %A, i64 %polly.indvar50, i64 %p_.moved.to.40
...
polly.stmt.66:                                    ; preds = %polly.cond60
  ...
  %p_scevgep21.moved.to.39 = getelementptr [2000 x double]* %A, i64 %4, i64 0
  %_p_scalar_67 = load double* %p_scevgep22.moved.to.
  %_p_scalar_68 = load double* %p_scevgep21.moved.to.39
  %p_69 = fdiv double %_p_scalar_68, %_p_scalar_67
  store double %p_69, double* %p_scevgep21.moved.to.39
  %25 = add i64 %4, -1
...
polly.loop_exit82:                                ; preds = %polly.loop_header80, %polly.loop_header71
  %p_.moved.to.95 = mul i64 %polly.indvar75, 2001
  %p_scevgep22.moved.to.96 = getelementptr [2000 x double]* %A, i64 0, i64 %p_.moved.to.95
  %p_scevgep21.moved.to.3997 = getelementptr [2000 x double]* %A, i64 %4, i64 %polly.indvar75
  %_p_scalar_98 = load double* %p_scevgep22.moved.to.96
  %_p_scalar_99 = load double* %p_scevgep21.moved.to.3997
  %p_100 = fdiv double %_p_scalar_99, %_p_scalar_98
  store double %p_100, double* %p_scevgep21.moved.to.3997
