...
polly.split_new_and_old45:
  %0 = zext i32 %n to i64
  %1 = sext i32 %n to i64
  %2 = icmp sge i64 %1, 1
  %3 = icmp sge i64 %0, 1
  %4 = and i1 %2, %3
  br i1 %4, label %polly.then50, label %polly.merge49

polly.merge:                                      ; preds = %polly.then, %polly.loop_exit21, %polly.merge49
  ret void

polly.then:                                       ; preds = %polly.merge49
  %5 = add i64 %0, -1
...
polly.merge49:                                    ; preds = %polly.then50, %polly.loop_header52, %polly.split_new_and_old45
  br i1 %4, label %polly.then, label %polly.merge

polly.then50:                                     ; preds = %polly.split_new_and_old45
  %62 = add i64 %0, -1
  %polly.loop_guard55 = icmp sle i64 0, %62
  br i1 %polly.loop_guard55, label %polly.loop_header52, label %polly.merge49
...
polly.loop_header52:                              ; preds = %polly.then50, %polly.loop_header52
  ...
  %p_ = add i64 %polly.indvar56, 1
  %p_61 = trunc i64 %p_ to i32
  %p_scevgep15 = getelementptr i8* %seq, i64 %polly.indvar56
  %p_62 = srem i32 %p_61, 4
  %p_63 = trunc i32 %p_62 to i8
  store i8 %p_63, i8* %p_scevgep15
  %polly.indvar_next57 = add nsw i64 %polly.indvar56, 1
  %polly.adjust_ub58 = sub i64 %62, 1
  %polly.loop_cond59 = icmp sle i64 %polly.indvar56, %polly.adjust_ub58
  br i1 %polly.loop_cond59, label %polly.loop_header52, label %polly.merge49
}
