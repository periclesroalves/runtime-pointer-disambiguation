...
.split:
  %0 = icmp sgt i32 %n, 0
  br i1 %0, label %.preheader2.lr.ph, label %._crit_edge10
...
.preheader2:                                      ; preds = %.preheader2.lr.ph, %._crit_edge7
  %indvar11 = phi i64 [ 0, %.preheader2.lr.ph ], [ %5, %._crit_edge7 ]
  %4 = mul i64 %indvar11, 9600
  %i.08 = trunc i64 %indvar11 to i32
  %5 = add i64 %indvar11, 1
  %6 = icmp slt i32 %i.08, 0
  br i1 %6, label %.preheader1, label %polly.cond

.preheader1:                                      ; preds = %polly.then29, %polly.loop_header, %polly.cond, %.preheader2
  br i1 %3, label %.preheader.lr.ph, label %._crit_edge7

.preheader.lr.ph:                                 ; preds = %.preheader1
  br label %.preheader

.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge
  %indvar16 = phi i64 [ 0, %.preheader.lr.ph ], [ %indvar.next17, %._crit_edge ]
  %scevgep22 = getelementptr [1000 x double]* %A, i64 %indvar11, i64 %indvar16
  br i1 %6, label %._crit_edge, label %.lr.ph5

.lr.ph5:                                          ; preds = %.preheader, %.lr.ph5
  %indvar13 = phi i64 [ %indvar.next14, %.lr.ph5 ], [ 0, %.preheader ]
  %scevgep19 = getelementptr [1200 x double]* %C, i64 %indvar11, i64 %indvar13
  %scevgep18 = getelementptr [1000 x double]* %A, i64 %indvar13, i64 %indvar16
  %7 = load double* %scevgep22, align 8, !tbaa !1
  %8 = fmul double %7, %alpha
  %9 = load double* %scevgep18, align 8, !tbaa !1
  %10 = fmul double %8, %9
  %11 = load double* %scevgep19, align 8, !tbaa !1
  %12 = fadd double %11, %10
  store double %12, double* %scevgep19, align 8, !tbaa !1
  %indvar.next14 = add i64 %indvar13, 1
  %exitcond15 = icmp ne i64 %indvar.next14, %5
  br i1 %exitcond15, label %.lr.ph5, label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph5, %.preheader
  %indvar.next17 = add i64 %indvar16, 1
  %exitcond20 = icmp ne i64 %indvar.next17, %1
  br i1 %exitcond20, label %.preheader, label %._crit_edge7

._crit_edge7:                                     ; preds = %._crit_edge, %.preheader1
  %exitcond23 = icmp ne i64 %5, %2
  br i1 %exitcond23, label %.preheader2, label %._crit_edge10

._crit_edge10:                                    ; preds = %._crit_edge7, %.split
  ret void

polly.cond:                                       ; preds = %.preheader2
  %13 = srem i64 %4, 8
  %14 = icmp eq i64 %13, 0
  %15 = icmp sge i64 %indvar11, 0
  %or.cond = and i1 %14, %15
  br i1 %or.cond, label %polly.then29, label %.preheader1

polly.then29:                                     ; preds = %polly.cond
  br i1 %15, label %polly.loop_header, label %.preheader1

polly.loop_header:                                ; preds = %polly.then29, %polly.loop_header
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_header ], [ 0, %polly.then29 ]
  %p_scevgep = getelementptr [1200 x double]* %C, i64 %indvar11, i64 %polly.indvar
  ...
  %polly.adjust_ub = sub i64 %indvar11, 1
  %polly.loop_cond = icmp sle i64 %polly.indvar, %polly.adjust_ub
