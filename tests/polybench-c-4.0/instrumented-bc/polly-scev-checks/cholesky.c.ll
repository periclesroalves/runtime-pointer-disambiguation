...
.preheader:                                       ; preds = %.preheader.lr.ph, %.region30
  %2 = phi i64 [ 0, %.preheader.lr.ph ], [ %indvar.next14, %.region30 ]
  %3 = trunc i64 %2 to i32
  %4 = mul i64 %2, 16000
  %p_75 = mul i64 %2, 2001
  %p_scevgep28 = getelementptr [2000 x double]* %A, i64 0, i64 %p_75
  %5 = srem i64 %4, 8
  %6 = icmp eq i64 %5, 0
  br i1 %6, label %polly.cond80, label %polly.merge78

.lr.ph7:                                          ; preds = %polly.merge78, %.lr.ph7
  %indvar20 = phi i64 [ %indvar.next21, %.lr.ph7 ], [ 0, %polly.merge78 ]
  %scevgep23 = getelementptr [2000 x double]* %A, i64 %2, i64 %indvar20
  %7 = load double* %scevgep23, align 8, !tbaa !6, !alias.scope !11
  %8 = fmul double %7, %7
  %9 = load double* %p_scevgep28, align 8, !tbaa !6, !alias.scope !11
  %10 = fsub double %9, %8
  store double %10, double* %p_scevgep28, align 8, !tbaa !6, !alias.scope !11
  %indvar.next21 = add i64 %indvar20, 1
  %exitcond22 = icmp ne i64 %indvar.next21, %2
  br i1 %exitcond22, label %.lr.ph7, label %.region30

.region30:                                        ; preds = %polly.merge78, %.lr.ph7
  %11 = load double* %p_scevgep28, align 8, !tbaa !6
  %12 = tail call double @sqrt(double %11) #3
  store double %12, double* %p_scevgep28, align 8, !tbaa !6
  %indvar.next14 = add i64 %2, 1
  %exitcond24 = icmp ne i64 %indvar.next14, %1
  br i1 %exitcond24, label %.preheader, label %._crit_edge10

._crit_edge10:                                    ; preds = %.region30, %.split
  ret void

polly.merge78:                                    ; preds = %polly.stmt.83, %polly.loop_exit107, %polly.cond80, %.preheader
  %13 = load double* %p_scevgep28, align 8, !tbaa !6, !alias.scope !11
  store double %13, double* %p_scevgep28, align 8, !tbaa !6, !alias.scope !11
  %14 = icmp sgt i32 %3, 0
  br i1 %14, label %.lr.ph7, label %.region30

polly.cond80:                                     ; preds = %.preheader
  %15 = icmp sge i64 %2, 1
  %16 = sext i32 %3 to i64
  %17 = icmp sge i64 %16, 1
  %18 = and i1 %15, %17
  br i1 %18, label %polly.stmt.83, label %polly.merge78

polly.stmt.83:                                    ; preds = %polly.cond80
  %p_scevgep18 = getelementptr [2000 x double]* %A, i64 %2, i64 0
  %_p_scalar_84 = load double* %p_scevgep18
  store double %_p_scalar_84, double* %p_scevgep18
  %p_scevgep19.moved.to. = getelementptr [2000 x double]* %A, i64 0, i64 0
  %_p_scalar_87 = load double* %p_scevgep19.moved.to.
  %p_89 = fdiv double %_p_scalar_84, %_p_scalar_87
  store double %p_89, double* %p_scevgep18
  %19 = add i64 %2, -1
  %polly.loop_guard94 = icmp sle i64 1, %19
  br i1 %polly.loop_guard94, label %polly.loop_header91, label %polly.merge78

polly.loop_header91:                              ; preds = %polly.stmt.83, %polly.loop_exit107
  %polly.indvar95 = phi i64 [ %polly.indvar_next96, %polly.loop_exit107 ], [ 1, %polly.stmt.83 ]
  %p_scevgep18100 = getelementptr [2000 x double]* %A, i64 %2, i64 %polly.indvar95
  %p_j.02101 = trunc i64 %polly.indvar95 to i32
  %_p_scalar_102 = load double* %p_scevgep18100
  store double %_p_scalar_102, double* %p_scevgep18100
  %20 = add i64 %polly.indvar95, -1
  %polly.loop_guard108 = icmp sle i64 0, %20
  br i1 %polly.loop_guard108, label %polly.loop_header105, label %polly.loop_exit107

polly.loop_exit107:                               ; preds = %polly.loop_header105, %polly.loop_header91
  %p_.moved.to.120 = mul i64 %polly.indvar95, 2001
  %p_scevgep19.moved.to.121 = getelementptr [2000 x double]* %A, i64 0, i64 %p_.moved.to.120
  %_p_scalar_123 = load double* %p_scevgep19.moved.to.121
  %_p_scalar_124 = load double* %p_scevgep18100
  %p_125 = fdiv double %_p_scalar_124, %_p_scalar_123
  store double %p_125, double* %p_scevgep18100
  %p_indvar.next12126 = add i64 %polly.indvar95, 1
  %polly.indvar_next96 = add nsw i64 %polly.indvar95, 1
  %polly.adjust_ub97 = sub i64 %19, 1
  %polly.loop_cond98 = icmp sle i64 %polly.indvar95, %polly.adjust_ub97
  br i1 %polly.loop_cond98, label %polly.loop_header91, label %polly.merge78

polly.loop_header105:                             ; preds = %polly.loop_header91, %polly.loop_header105
  %polly.indvar109 = phi i64 [ %polly.indvar_next110, %polly.loop_header105 ], [ 0, %polly.loop_header91 ]
  %p_scevgep = getelementptr [2000 x double]* %A, i64 %2, i64 %polly.indvar109
  %p_scevgep15 = getelementptr [2000 x double]* %A, i64 %polly.indvar95, i64 %polly.indvar109
  %_p_scalar_114 = load double* %p_scevgep
  %_p_scalar_115 = load double* %p_scevgep15
  %p_116 = fmul double %_p_scalar_114, %_p_scalar_115
  %_p_scalar_117 = load double* %p_scevgep18100
  %p_118 = fsub double %_p_scalar_117, %p_116
  store double %p_118, double* %p_scevgep18100
  %p_indvar.next = add i64 %polly.indvar109, 1
  %polly.indvar_next110 = add nsw i64 %polly.indvar109, 1
  %polly.adjust_ub111 = sub i64 %20, 1
...
!12 = metadata !{metadata !12, metadata !10, metadata !"kernel_cholesky: %A"}
