...
polly.split_new_and_old52:
  %0 = zext i32 %n to i64
  %1 = sext i32 %n to i64
  %2 = icmp sge i64 %1, 1
  %3 = icmp sge i64 %0, 1
  %4 = and i1 %2, %3
  br i1 %4, label %polly.then57, label %polly.merge56

polly.merge:                                      ; preds = %polly.then, %polly.loop_exit27, %polly.merge56
  ret void

polly.then:                                       ; preds = %polly.merge56
  %5 = add i64 %0, -1
  %polly.loop_guard = icmp sle i64 0, %5
  br i1 %polly.loop_guard, label %polly.loop_header, label %polly.merge

polly.loop_header:                                ; preds = %polly.then, %polly.loop_exit27
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit27 ], [ 0, %polly.then ]
  %6 = mul i64 -11, %0
  %7 = add i64 %6, 5
  %8 = sub i64 %7, 32
  %9 = add i64 %8, 1
  ...
  %polly.loop_guard28 = icmp sle i64 %29, %30
  br i1 %polly.loop_guard28, label %polly.loop_header25, label %polly.loop_exit27

polly.loop_exit27:                                ; preds = %polly.loop_exit36, %polly.loop_header
...
polly.loop_header25:                              ; preds = %polly.loop_header, %polly.loop_exit36
  %polly.indvar29 = phi i64 [ %polly.indvar_next30, %polly.loop_exit36 ], [ %29, %polly.loop_header ]
  %31 = mul i64 -1, %polly.indvar29
  %32 = mul i64 -1, %0
  %33 = add i64 %31, %32
  %34 = add i64 %33, -30
  %35 = add i64 %34, 20
  ...
  %polly.loop_guard37 = icmp sle i64 %41, %51
  br i1 %polly.loop_guard37, label %polly.loop_header34, label %polly.loop_exit36

polly.loop_exit36:                                ; preds = %polly.loop_exit45, %polly.loop_header25
  %polly.indvar_next30 = add nsw i64 %polly.indvar29, 32
  %polly.adjust_ub31 = sub i64 %30, 32
...
polly.loop_header34:                              ; preds = %polly.loop_header25, %polly.loop_exit45
  %polly.indvar38 = phi i64 [ %polly.indvar_next39, %polly.loop_exit45 ], [ %41, %polly.loop_header25 ]
  %52 = mul i64 -20, %polly.indvar38
  %53 = add i64 %52, %32
  %54 = add i64 %53, 1
  %55 = icmp sgt i64 %polly.indvar29, %54
  %56 = select i1 %55, i64 %polly.indvar29, i64 %54
  %57 = add i64 %polly.indvar29, 31
  %58 = icmp slt i64 %52, %57
  %59 = select i1 %58, i64 %52, i64 %57
  %polly.loop_guard46 = icmp sle i64 %56, %59
  br i1 %polly.loop_guard46, label %polly.loop_header43, label %polly.loop_exit45

polly.loop_exit45:                                ; preds = %polly.loop_header43, %polly.loop_header34
  %polly.indvar_next39 = add nsw i64 %polly.indvar38, 1
  %polly.adjust_ub40 = sub i64 %51, 1
...
polly.loop_header43:                              ; preds = %polly.loop_header34, %polly.loop_header43
  %polly.indvar47 = phi i64 [ %polly.indvar_next48, %polly.loop_header43 ], [ %56, %polly.loop_header34 ]
  %60 = mul i64 -1, %polly.indvar47
  %61 = add i64 %52, %60
  %p_scevgep = getelementptr [2500 x i32]* %table, i64 %polly.indvar38, i64 %61
  store i32 0, i32* %p_scevgep
  %p_indvar.next = add i64 %61, 1
  %polly.indvar_next48 = add nsw i64 %polly.indvar47, 1
  %polly.adjust_ub49 = sub i64 %59, 1
...
polly.merge56:                                    ; preds = %polly.then57, %polly.loop_header59, %polly.split_new_and_old52
  br i1 %4, label %polly.then, label %polly.merge

polly.then57:                                     ; preds = %polly.split_new_and_old52
  %62 = add i64 %0, -1
  %polly.loop_guard62 = icmp sle i64 0, %62
  br i1 %polly.loop_guard62, label %polly.loop_header59, label %polly.merge56

polly.loop_header59:                              ; preds = %polly.then57, %polly.loop_header59
  %polly.indvar63 = phi i64 [ %polly.indvar_next64, %polly.loop_header59 ], [ 0, %polly.then57 ]
  %p_ = add i64 %polly.indvar63, 1
  %p_68 = trunc i64 %p_ to i32
  %p_scevgep15 = getelementptr i8* %seq, i64 %polly.indvar63
  %p_69 = srem i32 %p_68, 4
  %p_70 = trunc i32 %p_69 to i8
  store i8 %p_70, i8* %p_scevgep15
  %polly.indvar_next64 = add nsw i64 %polly.indvar63, 1
  %polly.adjust_ub65 = sub i64 %62, 1
  %polly.loop_cond66 = icmp sle i64 %polly.indvar63, %polly.adjust_ub65
  br i1 %polly.loop_cond66, label %polly.loop_header59, label %polly.merge56
}
...
.loopexit:                                        ; preds = %.region, %.preheader3
...
; <label>:24                                      ; preds = %.lr.ph6, %.region
  %indvar15 = phi i64 [ 0, %.lr.ph6 ], [ %indvar.next16, %.region ]
...
; <label>:51                                      ; preds = %44, %43
  ...
  br i1 %or.cond, label %52, label %.preheader.split
...
.preheader.split:                                 ; preds = %51, %73, %68
  %75 = icmp slt i32 %i.0.in8, %j.05
  br i1 %75, label %.lr.ph, label %.region

.lr.ph:                                           ; preds = %.preheader.split, %85
  %indvar = phi i64 [ %indvar.next, %85 ], [ 0, %.preheader.split ]
  ...
  %78 = load i32* %scevgep20, align 4, !tbaa !6, !alias.scope !8, !noalias !11
  %79 = load i32* %scevgep, align 4, !tbaa !6, !alias.scope !8, !noalias !11
  %80 = load i32* %scevgep17, align 4, !tbaa !6, !alias.scope !8, !noalias !11
...
; <label>:85                                      ; preds = %84, %83
  ...
  store i32 %.reg2mem.0, i32* %scevgep20, align 4, !tbaa !6, !alias.scope !8, !noalias !11
  %indvar.next = add i64 %indvar, 1
  %exitcond = icmp ne i64 %indvar.next, %33
  br i1 %exitcond, label %.lr.ph, label %.region

.region:                                          ; preds = %.preheader.split, %85
...
!9 = metadata !{metadata !9, metadata !10, metadata !"kernel_nussinov: %table"}
!10 = metadata !{metadata !10, metadata !"init_array"}
!11 = metadata !{metadata !12}
!12 = metadata !{metadata !12, metadata !10, metadata !"kernel_nussinov: %.reg2mem"}
